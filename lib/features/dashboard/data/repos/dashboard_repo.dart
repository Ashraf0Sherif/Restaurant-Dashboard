...
class DashboardRepo {
  ...
  Future<FirebaseResult<OrderRateModel>> fetchOrderRate()async{
    try {
      OrderRateModel orderRateModel = await restaurantFirebase.getOrderRate();
      return FirebaseResult.success(orderRateModel);
    } catch (error) {
      return FirebaseResult.failure(
          FirebaseExceptions.getFirebaseException(error));
    }
