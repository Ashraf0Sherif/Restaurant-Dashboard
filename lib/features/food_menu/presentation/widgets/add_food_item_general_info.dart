...
class AddFoodItemGeneralInfo extends StatefulWidget {
  const AddFoodItemGeneralInfo({
    ...
    required this.arabicTitleController,
    required this.arabicDescriptionController,
  });
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text("Arabic Title"),
        CustomTextFormField(
          label: '',
          onChanged: (text) {},
          controller: widget.arabicTitleController,
        ),
        const SizedBox(
          height: 10,
        ),
        ...
        const Text("Arabic Description"),
        CustomTextFormField(
          maxLines: 5,
          minLines: 5,
          label: '',
          onChanged: (text) {},
          controller: widget.arabicDescriptionController,
        ),
        const SizedBox(
          height: 10,
        ),
