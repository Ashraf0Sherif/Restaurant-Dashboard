...
class _CategoryFoodItemsViewState extends State<CategoryFoodItemsView> {
  ...
  List<Widget> buildFoodItemRow(FoodItem foodItem) {
    foodItemsIndex++;
    return [
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: NetworkImage(foodItem.images[0]),
              fit: BoxFit.fill,
            ),
          ),
        ),
      ),
      buildCell(foodItem.title),
      buildCell(foodItem.price),
      Container(
        color: Colors.blue.shade300,
        child: Center(
          child: IconButton(
          ...
          child: IconButton(
            onPressed: () {
              BlocProvider.of<FoodMenuCubit>(context).deleteFoodItem(
                  categoryId: widget.categoryId, foodId: foodItem.id);
              foodItemsIndex = 0;
            },
            icon: const Icon(
              Icons.delete_sharp,
