...
class AddFoodItemTabletLayout extends StatefulWidget {
  final String categoryId;
  final String category;
  final List<FoodItem> categoryItems;
  final FoodItem? existingItem;

  const AddFoodItemTabletLayout({
    super.key,
  ...
  @override
  State<AddFoodItemTabletLayout> createState() =>
      _AddFoodItemTabletLayoutState();
}

class _AddFoodItemTabletLayoutState extends State<AddFoodItemTabletLayout> {
  @override
